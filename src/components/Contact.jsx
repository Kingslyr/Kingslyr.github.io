export default function Contact() {
  return (
    <section id="contact" className="mx-auto w-full max-w-6xl px-6 pb-24 pt-6 scroll-mt-28">
      ...
      >
        <h3 className="mb-1 text-center text-3xl font-semibold text-white">Get in Touch</h3>
        <p className="text-center text-sm text-white/75">Tell us about your project and we will get back quickly.</p>
